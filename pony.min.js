;(function(context,undefined){var
    ...
    if(synchronousPublish){while(subscribersLen--){deliverMessage(subscribers[subscribersLen],data);}}else{while(subscribersLen--){setTimeout((function(subscriber,data){return function(){deliverMessage(subscriber,data);};})(subscribers[subscribersLen],data),0);}}
